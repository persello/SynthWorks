...
internal enum StoryboardScene {
  ...
  internal enum Main: StoryboardType {
    ...
    internal static let initialScene = InitialSceneType<DocumentBrowserViewController>(storyboard: Main.self)

    internal static let documentBrowserViewController = SceneType<DocumentBrowserViewController>(storyboard: Main.self, identifier: "DocumentBrowserViewController")
